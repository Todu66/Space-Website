...
First.addEventListener('click', function() {
    ...
    slideThird.innerHTML = "Douglas Gerald Hurley is an American engineer, former <br>\ Marine Corps pilot and former NASA astronaut. He<br>\ launched into space for the third time as commander of<br>\ Crew Dragon Demo-2.";
...
Second.addEventListener('click', function() {
    ...
    slideThird.innerHTML = "Mark Richard Shuttleworth is the founder and CEO of <br>\ Canonical, the company behind the Linux-based Ubuntu <br>\ operating system. Shuttleworth became the first South <br>\ African to travel to space as a space tourist."
...
Third.addEventListener('click', function() {
    ...
    slideThird.innerHTML = "Pilot on the first operational flight of the SpaceX Crew<br>\ Dragon to the International Space Station. Glover is a<br>\ commander in the U.S. Navy where he pilots an F/A-18.He<br>\ was a crew member of Expedition 64, and served as a<br>\ station systems flight engineer. "
...
Fourth.addEventListener('click', function() {
    ...
    slideThird.innerHTML = "Anousheh Ansari is an Iranian American engineer and<br>\ co-founder of Prodea Systems. Ansari was the fourth<br>\ self-funded space tourist, the first self-funded woman to<br>\ fly to the ISS, and the first Iranian in space. "
